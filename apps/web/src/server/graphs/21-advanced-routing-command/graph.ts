...
// You'll need Command, Annotation, StateGraph, START, END from "@langchain/langgraph"
// and createLLM from "../../lib/llm"

// TODO (Lesson 22, Step 2): Define ModerationState using Annotation.Root
// Include fields: messages, toxicityScore, moderationDecision, moderatorNotes
...
// Read the message, score toxicity, then return new Command({ update: {...}, goto: "..." })
