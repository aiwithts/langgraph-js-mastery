...
// You'll need:
//   import { Annotation, END, MessagesAnnotation, START, StateGraph, type LangGraphRunnableConfig } from "@langchain/langgraph";
//   import { createLLM } from "../../lib/llm";
//   import { ASSISTANT_PROMPT } from "./prompts";

// TODO (Lesson 05, Step 2, Task 2): Define SpecialtyState
// Use Annotation.Root({ ...MessagesAnnotation.spec })
// Add: specialty: Annotation<string> — reducer: (_, next) => next, default: () => "programming"

// TODO (Lesson 05, Step 3): Define assistantNode
