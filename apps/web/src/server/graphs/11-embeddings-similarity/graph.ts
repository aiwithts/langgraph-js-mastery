...
// You'll need:
//   import { ChatPromptTemplate, FewShotChatMessagePromptTemplate, MessagesPlaceholder } from "@langchain/core/prompts";
//   import { Annotation, END, MessagesAnnotation, START, StateGraph } from "@langchain/langgraph";
//   import { createLLM } from "../../lib/llm";
// For embeddings (requires OpenAI key):
//   import { OpenAIEmbeddings } from "@langchain/openai";

// TODO (Lesson 12, Step 2): Define your example bank
...
// TODO (Lesson 12, Step 3): Implement cosine similarity helper
// function cosineSimilarity(a: number[], b: number[]): number
// Formula: dot(a,b) / (magnitude(a) * magnitude(b))

// TODO (Lesson 12, Step 4): Implement selectExamples function
...
// TODO (Lesson 12, Step 5): Define ExampleSelectorState
...
// TODO (Lesson 12, Step 6): Define selectExamplesNode
// - Get the last user message
// - Call selectExamples(userQuery, 2)
// - Return: { selectedExamples: examples }

// TODO (Lesson 12, Step 7): Define respondNode
...
// TODO (Lesson 12, Step 8): Build graph: START → selectExamples → respond → END

export function createGraph(checkpointer?: PostgresSaver): CompiledGraph {
	// TODO (Lesson 12, Step 9): Compile and return
