 ...
 * ReadableStream, checkpointer setup, and graph.stream() loop in Step 2 below.
 *
...
export async function POST(req: Request) {
	...
	// TODO (Lesson 03, Step 2, Task 1): Create the TextEncoder and define a send() helper
	...
	// TODO (Lesson 03, Step 2, Task 2): Set up the checkpointer and create the graph
	...
	// TODO (Lesson 03, Step 2, Task 3): Stream tokens and send SSE events
	...
	// TODO (Lesson 03, Step 2, Task 4): Return a Response with SSE headers

	// Placeholder — replace with your ReadableStream implementation in Step 2
	return Response.json({ error: "Not implemented — complete Lesson 03, Step 2" }, { status: 501 });
}
